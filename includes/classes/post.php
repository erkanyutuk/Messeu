        ...
        if (mysqli_num_rows($data_query) > 0) {
            ...
            while ($row = mysqli_fetch_array($data_query)) {
                ...
                if ($user_loged_obj->isFriend($added_by)) {
                    ...
                    $fname = $user_rows['first_name'];
                    $lname = $user_rows['last_name'];
...
<?php
                    ...
                    <div class='col-lg-5 post_main' onClick='javascript:toggle$id()'>

                            <div class=' mb-4' style='height:auto' id='post_body'>
                            " . $body . "
                            <br>
                            <br>
