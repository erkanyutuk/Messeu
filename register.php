...
<head>
    <meta charset="UTF-8">
    <title>Register Erkan Yutuk Social Network</title>
...
<body>
    ...
    <div id="main">
        <div id="main_color"></div>
            ...
            echo $_SESSION['login_email']; }    ?>" required>
                        </div>
                        <div id="input">
                        ...
                        <?php if(in_array('Email or Password was incorrect<br>',$error)){echo 'Email or Password was incorrect<br>';} ?>
            ...
            echo $_SESSION['reg_lname']; }    ?>" required>
                        ...
                        <?php if(in_array('Your First Name must be between 2 and 25 character<br>',$error)){echo 'Your First Name must be between 2 and 25 character<br>';} ?>
                        <?php if(in_array('Your Last Name must be between 2 and 25 character<br>',$error)){echo 'Your Last Name must be between 2 and 25 character<br>';} ?>
            ...
            echo $_SESSION['reg_email']; }    ?>" required>
             ...
             else if(in_array('Email Address is invalid<br>',$error)){echo 'Email Address is invalid<br>';} ?>
                        ...
                        <?php if(in_array('Your Password must be between 5 and 30 character<br>',$error)){echo 'Your Password must be between 5 and 30 character<br>';} ?>
                        ...
                        <?php if(in_array('Password dont Match<br>',$error)){echo 'Password dont Match<br>';} ?>
